...
public class FurgonetkaShippingProviderDescriptor implements ShippingProviderDescriptor {
    ...
    public List<EventBinding<?>> bindings() {
        return List.of(new WebhookBinding<>("furgonetka", String.class, this::handleWebhook));
    }

    private ShippingWebhookResult handleWebhook(String payload, WebhookContext ctx) {
        try {
