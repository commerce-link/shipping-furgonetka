...
public class FurgonetkaShippingProviderDescriptor implements ShippingProviderDescriptor {
    ...
    public Map<String, String> metadata() {
        return Map.of(
                "authType", "oauth2",
                "authEndpointPath", "/oauth/token",
                "refreshEndpointPath", "/oauth/token",
                "refreshTokenExpirationSeconds", String.valueOf(29L * 24 * 60 * 60),
                "acceptHeader", "application/vnd.furgonetka.v1+json"
        );
    }
    ...
    public List<ProviderField> configurationFields() {
        return List.of(
                new ProviderField("apiUrl", "API URL", TEXT, true, "https://api.furgonetka.pl"),
